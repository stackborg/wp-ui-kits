...
export function Alert({ children, variant = 'info', dismissible = false, onDismiss, icon, ...rest }) {
    ...
    return (_jsxs("div", { ...rest, role: "alert", style: {
            ...
            gap: '8px',
        }, children: [_jsx("span", { style: { flexShrink: 0, lineHeight: 1 }, children: icon ?? style.icon }), _jsx("div", { style: { flex: 1 }, children: children }), dismissible && (_jsx("button", { onClick: handleDismiss, "aria-label": "Dismiss", style: {
                    background: 'none',
                    border: 'none',
                    cursor: 'pointer',
                    color: style.color,
